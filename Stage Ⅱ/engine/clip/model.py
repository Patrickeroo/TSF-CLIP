...
def build_model(state_dict: dict):
    ...
    pretrained_path = "Storage path of stage Ⅰ pre-trained model weights"
    state = torch.load(pretrained_path)["model_state_dict"]
    state =preserve_key(state, "model.visual")
